...
.PHONY: gen
gen:
	@yq r vendor/stash.appscode.dev/installer/api/crds/installer.stash.appscode.com_stashelasticsearchs.yaml spec.validation.openAPIV3Schema.properties.spec > /tmp/stash-elasticsearch-values.openapiv3_schema.yaml
