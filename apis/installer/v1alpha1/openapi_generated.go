...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.ElasticsearchBackup":    schema_elasticsearch_apis_installer_v1alpha1_ElasticsearchBackup(ref),
		"stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.ElasticsearchRestore":   schema_elasticsearch_apis_installer_v1alpha1_ElasticsearchRestore(ref),
		"stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.ImageRef":               schema_elasticsearch_apis_installer_v1alpha1_ImageRef(ref),
		"stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.StashElasticsearch":     schema_elasticsearch_apis_installer_v1alpha1_StashElasticsearch(ref),
		"stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.StashElasticsearchList": schema_elasticsearch_apis_installer_v1alpha1_StashElasticsearchList(ref),
		"stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.StashElasticsearchSpec": schema_elasticsearch_apis_installer_v1alpha1_StashElasticsearchSpec(ref),
	}
}
...
func schema_elasticsearch_apis_installer_v1alpha1_ElasticsearchBackup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_elasticsearch_apis_installer_v1alpha1_ElasticsearchRestore(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_elasticsearch_apis_installer_v1alpha1_ImageRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_elasticsearch_apis_installer_v1alpha1_StashElasticsearch(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.StashElasticsearchSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.StashElasticsearchSpec"},
	}
}

func schema_elasticsearch_apis_installer_v1alpha1_StashElasticsearchList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "StashElasticsearchList is a list of StashElasticsearches",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.StashElasticsearch"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.StashElasticsearch"},
	}
}

func schema_elasticsearch_apis_installer_v1alpha1_StashElasticsearchSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"image": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.ImageRef"),
						},
					},
					"backup": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.ElasticsearchBackup"),
						},
					},
					"restore": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.ElasticsearchRestore"),
						},
					},
					"waitTimeout": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.ElasticsearchBackup", "stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.ElasticsearchRestore", "stash.appscode.dev/elasticsearch/apis/installer/v1alpha1.ImageRef"},
	}
}
