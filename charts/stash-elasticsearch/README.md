...
$ helm repo update
$ helm install stash-elasticsearch-7.3.2-beta.20200709 appscode/stash-elasticsearch -n kube-system --version=7.3.2-beta.20200709
```
...
To install the chart with the release name `stash-elasticsearch-7.3.2-beta.20200709`:
...
To uninstall/delete the `stash-elasticsearch-7.3.2-beta.20200709`:

```console
$ helm delete stash-elasticsearch-7.3.2-beta.20200709 -n kube-system
```
...
```console
$ helm install stash-elasticsearch-7.3.2-beta.20200709 appscode/stash-elasticsearch -n kube-system --version=7.3.2-beta.20200709 --set image.registry=stashed
```
...
```console
$ helm install stash-elasticsearch-7.3.2-beta.20200709 appscode/stash-elasticsearch -n kube-system --version=7.3.2-beta.20200709 --values values.yaml
```
