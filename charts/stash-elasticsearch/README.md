...
$ helm repo update
$ helm install stash-elasticsearch-7.3.2-beta.20200708 appscode/stash-elasticsearch -n kube-system --version=7.3.2-beta.20200708
```
...
To install the chart with the release name `stash-elasticsearch-7.3.2-beta.20200708`:
...
To uninstall/delete the `stash-elasticsearch-7.3.2-beta.20200708`:

```console
$ helm delete stash-elasticsearch-7.3.2-beta.20200708 -n kube-system
```
...
```console
$ helm install stash-elasticsearch-7.3.2-beta.20200708 appscode/stash-elasticsearch -n kube-system --version=7.3.2-beta.20200708 --set image.registry=stashed
```
...
```console
$ helm install stash-elasticsearch-7.3.2-beta.20200708 appscode/stash-elasticsearch -n kube-system --version=7.3.2-beta.20200708 --values values.yaml
```
