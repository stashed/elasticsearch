...
$ helm repo update
$ helm install stash-elasticsearch-v2020.07.08-beta.0 appscode/stash-elasticsearch -n kube-system --version=v2020.07.08-beta.0
```
...
To install the chart with the release name `stash-elasticsearch-v2020.07.08-beta.0`:
...
To uninstall/delete the `stash-elasticsearch-v2020.07.08-beta.0`:

```console
$ helm delete stash-elasticsearch-v2020.07.08-beta.0 -n kube-system
```
...
```console
$ helm install stash-elasticsearch-v2020.07.08-beta.0 appscode/stash-elasticsearch -n kube-system --version=v2020.07.08-beta.0 --set image.registry=stashed
```
...
```console
$ helm install stash-elasticsearch-v2020.07.08-beta.0 appscode/stash-elasticsearch -n kube-system --version=v2020.07.08-beta.0 --values values.yaml
```
