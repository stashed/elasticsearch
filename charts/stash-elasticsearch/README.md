...
$ helm repo update
$ helm install stash-elasticsearch-6.3.0-beta.20200708 appscode/stash-elasticsearch -n kube-system --version=6.3.0-beta.20200708
```
...
To install the chart with the release name `stash-elasticsearch-6.3.0-beta.20200708`:
...
To uninstall/delete the `stash-elasticsearch-6.3.0-beta.20200708`:

```console
$ helm delete stash-elasticsearch-6.3.0-beta.20200708 -n kube-system
```
...
```console
$ helm install stash-elasticsearch-6.3.0-beta.20200708 appscode/stash-elasticsearch -n kube-system --version=6.3.0-beta.20200708 --set image.registry=stashed
```
...
```console
$ helm install stash-elasticsearch-6.3.0-beta.20200708 appscode/stash-elasticsearch -n kube-system --version=6.3.0-beta.20200708 --values values.yaml
```
