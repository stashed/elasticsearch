...
$ helm repo update
$ helm install stash-elasticsearch-7.2.0-v6 appscode/stash-elasticsearch -n kube-system --version=7.2.0-v6
```
...
To install the chart with the release name `stash-elasticsearch-7.2.0-v6`:
...
```console
$ helm delete stash-elasticsearch-7.2.0-v6 -n kube-system
```
...
```console
$ helm install stash-elasticsearch-7.2.0-v6 appscode/stash-elasticsearch -n kube-system --version=7.2.0-v6 --set image.registry=stashed
```
...
```console
$ helm install stash-elasticsearch-7.2.0-v6 appscode/stash-elasticsearch -n kube-system --version=7.2.0-v6 --values values.yaml
```
