...
$ helm repo update
$ helm install stash-elasticsearch-v2021.03.08 appscode/stash-elasticsearch -n kube-system --version=v2021.03.08
```
...
To install the chart with the release name `stash-elasticsearch-v2021.03.08`:
...
To uninstall/delete the `stash-elasticsearch-v2021.03.08`:

```console
$ helm delete stash-elasticsearch-v2021.03.08 -n kube-system
```
...
| image.tag        | Tag of the image that is used to backup/restore Elasticsearch database. This is usually same as the database version it can backup. | `v2021.03.08`         |
...
```console
$ helm install stash-elasticsearch-v2021.03.08 appscode/stash-elasticsearch -n kube-system --version=v2021.03.08 --set image.registry=stashed
```
...
```console
$ helm install stash-elasticsearch-v2021.03.08 appscode/stash-elasticsearch -n kube-system --version=v2021.03.08 --values values.yaml
```
