...
$ helm repo update
$ helm install stash-elasticsearch-v2020.08.27-rc.0 appscode/stash-elasticsearch -n kube-system --version=v2020.08.27-rc.0
```
...
To install the chart with the release name `stash-elasticsearch-v2020.08.27-rc.0`:
...
To uninstall/delete the `stash-elasticsearch-v2020.08.27-rc.0`:

```console
$ helm delete stash-elasticsearch-v2020.08.27-rc.0 -n kube-system
```
...
| image.tag        | Tag of the image that is used to backup/restore Elasticsearch database. This is usually same as the database version it can backup. | `v2020.08.27-rc.0`    |
...
```console
$ helm install stash-elasticsearch-v2020.08.27-rc.0 appscode/stash-elasticsearch -n kube-system --version=v2020.08.27-rc.0 --set image.registry=stashed
```
...
```console
$ helm install stash-elasticsearch-v2020.08.27-rc.0 appscode/stash-elasticsearch -n kube-system --version=v2020.08.27-rc.0 --values values.yaml
```
