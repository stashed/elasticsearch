...
func generateSwaggerJson() {
	...
	apispec, err := openapi.RenderOpenAPISpec(openapi.Config{
		...
		Resources: []openapi.TypeInfo{
			{api.SchemeGroupVersion, api.ResourceStashElasticsearches, api.ResourceKindStashElasticsearch, false},
		},
	})
	if err != nil {
		glog.Fatal(err)
	...
	filename := gort.GOPath() + "/src/stash.appscode.dev/elasticsearch/api/openapi-spec/swagger.json"
